    ...
    render() {
        ...
        return (
            <li id="concert-list">
                ...
                <img src={this.props.concert.images[0].url} style={{width: "275px", height:"200px"}} alt="" id="concert-images"/>
                ...
                <h3>City: {this.props.concert._embedded.venues[0].city.name}</h3>
